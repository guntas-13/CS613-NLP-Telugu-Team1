...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        container = soup.find('div', class_='two-col-left-block').find('div')
        if container:
            title = container.find('div',class_='center')
            if title:
                title = title.text
            content = container.find('div', class_='text-justify')
            if content:
...
csv_path = "./Links/eenadu_failed.csv"

df = pd.read_csv(csv_path)

if __name__ == "__main__":
    output_folder = "/home/devil/Desktop/Texts/eenadu"
    failed_csv_path = "./Links/eenadu_failed.csv"
