...
df = pd.read_csv("telugu_wiki_links.csv")
...
def extract_data_from_html(html_content):
    try:
        ...
        all_text_elements = main_div.text
        extracted_data = all_text_elements.strip()
    except Exception as e:
...
if __name__ == "__main__":
    output_folder = "./TeluguWiki"
    failed_csv_path = "./failed_links.csv"
